...
public class TraderAccountController {
    ...
    @ApiOperation(value = "Delete a trader",
            notes = "Delete a trader IFF its account is 0 and no open positions."
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 400, message = "Unable to deposit due to the user input")
    })
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 404, message = "traderId is not found"),
            @ApiResponse(code = 400, message = "Unable to withdraw due to the user input")})
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
